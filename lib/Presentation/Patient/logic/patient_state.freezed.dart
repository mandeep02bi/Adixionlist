...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PatientListState<T>);
}
...
/// @nodoc
class $PatientListStateCopyWith<T,$Res>  {
$PatientListStateCopyWith(PatientListState<T> _, $Res Function(PatientListState<T>) __);
}


/// Adds pattern-matching-related methods to [PatientListState].
extension PatientListStatePatterns<T> on PatientListState<T> {
...
class _Initial<T> implements PatientListState<T> {
  const _Initial();
...
@override
String toString() {
  return 'PatientListState<$T>.initial()';
}
...
class Loading<T> implements PatientListState<T> {
  const Loading();
...
@override
String toString() {
  return 'PatientListState<$T>.loading()';
}
...
class Success<T> implements PatientListState<T> {
...
@override
String toString() {
  return 'PatientListState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $PatientListStateCopyWith<T, $Res> {
...
class Error<T> implements PatientListState<T> {
...
@override
String toString() {
  return 'PatientListState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $PatientListStateCopyWith<T, $Res> {
