...
part of 'certificate_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CertificateState<T>);
}
...
/// @nodoc
class $CertificateStateCopyWith<T,$Res>  {
$CertificateStateCopyWith(CertificateState<T> _, $Res Function(CertificateState<T>) __);
}


/// Adds pattern-matching-related methods to [CertificateState].
extension CertificateStatePatterns<T> on CertificateState<T> {
...
class _Initial<T> implements CertificateState<T> {
  const _Initial();
...
@override
String toString() {
  return 'CertificateState<$T>.initial()';
}
...
class Loading<T> implements CertificateState<T> {
  const Loading();
...
@override
String toString() {
  return 'CertificateState<$T>.loading()';
}
...
class Success<T> implements CertificateState<T> {
...
@override
String toString() {
  return 'CertificateState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $CertificateStateCopyWith<T, $Res> {
...
class Error<T> implements CertificateState<T> {
...
@override
String toString() {
  return 'CertificateState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $CertificateStateCopyWith<T, $Res> {
