...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecordsState<T>);
}
...
/// @nodoc
class $RecordsStateCopyWith<T,$Res>  {
$RecordsStateCopyWith(RecordsState<T> _, $Res Function(RecordsState<T>) __);
}


/// Adds pattern-matching-related methods to [RecordsState].
extension RecordsStatePatterns<T> on RecordsState<T> {
...
class _Initial<T> implements RecordsState<T> {
  const _Initial();
...
class Loading<T> implements RecordsState<T> {
  const Loading();
...
class Success<T> implements RecordsState<T> {
...
@override
String toString() {
  return 'RecordsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $RecordsStateCopyWith<T, $Res> {
...
class Error<T> implements RecordsState<T> {
...
@override
String toString() {
  return 'RecordsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $RecordsStateCopyWith<T, $Res> {
