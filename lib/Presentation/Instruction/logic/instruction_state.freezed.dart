...
part of 'instruction_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InstructionState<T>);
}
...
/// @nodoc
class $InstructionStateCopyWith<T,$Res>  {
$InstructionStateCopyWith(InstructionState<T> _, $Res Function(InstructionState<T>) __);
}


/// Adds pattern-matching-related methods to [InstructionState].
extension InstructionStatePatterns<T> on InstructionState<T> {
...
class _Initial<T> implements InstructionState<T> {
  const _Initial();
...
@override
String toString() {
  return 'InstructionState<$T>.initial()';
}
...
class Loading<T> implements InstructionState<T> {
  const Loading();
...
@override
String toString() {
  return 'InstructionState<$T>.loading()';
}
...
class Success<T> implements InstructionState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of InstructionState
...
@override
String toString() {
  return 'InstructionState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $InstructionStateCopyWith<T, $Res> {
...
class Error<T> implements InstructionState<T> {
...
@override
String toString() {
  return 'InstructionState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $InstructionStateCopyWith<T, $Res> {
