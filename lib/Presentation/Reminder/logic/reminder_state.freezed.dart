...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReminderState<T>);
}
...
/// @nodoc
class $ReminderStateCopyWith<T,$Res>  {
$ReminderStateCopyWith(ReminderState<T> _, $Res Function(ReminderState<T>) __);
}


/// Adds pattern-matching-related methods to [ReminderState].
extension ReminderStatePatterns<T> on ReminderState<T> {
...
class _Initial<T> implements ReminderState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ReminderState<$T>.initial()';
}
...
class Loading<T> implements ReminderState<T> {
  const Loading();
...
@override
String toString() {
  return 'ReminderState<$T>.loading()';
}
...
class Success<T> implements ReminderState<T> {
...
@override
String toString() {
  return 'ReminderState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ReminderStateCopyWith<T, $Res> {
...
class Error<T> implements ReminderState<T> {
...
@override
String toString() {
  return 'ReminderState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ReminderStateCopyWith<T, $Res> {
