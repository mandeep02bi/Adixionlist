      ...
      pw.MultiPage(
        ...
        build: (context) {
          return [
            ...
            pw.Text("Working Days : Mon,Tue,Wed,Thu,Fri", style: body()),

            pw.SizedBox(height: 3),

            pw.Text("Visiting Hours : 9 am - 2 pm, 5 pm - 9 pm", style: body()),

            pw.SizedBox(height: 3),

            pw.Text("Contact : +91 87654 44666", style: body()),

            pw.SizedBox(height: 3),

            pw.Text("Mail Id : draksdr@gmail.com", style: body()),

            pw.SizedBox(height: 3),

            pw.Text(
              "Address : Civil Lines Near Pipal Tiraha Balrampur U.P",
              style: body(),
            ),
            ...
            if (medicines.isNotEmpty) ...[
              ...
              pw.Text("℞", style: pw.TextStyle(font: boldFont, fontSize: 30)),
              ...
              ...medicines.map((m) {
                return pw.Padding(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      pw.Text(
                        "- ${m.name}, Total Quantity : ${m.totalQuantity ?? "-"}",
                        style: pw.TextStyle(font: boldFont, fontSize: 11),
                      ),

                      pw.SizedBox(height: 3),

                      pw.Text("for ${m.noOfDays ?? "-"} Days", style: body()),

                      pw.SizedBox(height: 3),

                      pw.Text(m.instructions ?? "-", style: body()),
                    ],
                  ),
                );
              }),
            ...
            if (labTests.isNotEmpty) ...[
              ...
              ...labTests.map(
                (lab) => pw.Padding(
                  ...
                  child: pw.Text("- ${lab.testName}", style: body(bold: true)),
                ),
              ),
